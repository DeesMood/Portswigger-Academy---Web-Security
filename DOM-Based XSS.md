...
![](Pasted%20image%2020260101134533.png)
...
![](Pasted%20image%2020260101194052.png)
...
**Steal cookie payload**
> the single quotes inside fetch() needed to be escaped(\) to not interfere with the existing single quotes from 
